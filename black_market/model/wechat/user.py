...
class WechatUser(db.Model):
    ...
    def __init__(self, open_id, nick_name, avatar_url, city,
    ...
    @classmethod
    def add(cls, open_id, nick_name, avatar_url, city,
            country, gender, language, province):
        instance = cls.get_by_open_id(open_id)
        if instance:
            instance.update(nick_name, avatar_url, city, country,
                            gender, language, province)
            return instance.id

        update_time = datetime.now()
        wechat_user = WechatUser(
            open_id, nick_name, avatar_url, city,
            country, gender, language, province, update_time)
    ...
    def update(self, nick_name, avatar_url, city, country,
               gender, language, province):
        self.nick_name = nick_name
        self.avatar_url = avatar_url
        self.city = city
